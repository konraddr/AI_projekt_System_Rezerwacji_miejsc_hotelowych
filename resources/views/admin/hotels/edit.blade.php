...
@section('admin-content')
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('manage.admin.hotels.show', $hotel) }}">{{ $hotel->name }}</a></li>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('manage.admin.hotels.update', $hotel) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="owner_id" id="owner_id" class="form-select @error('owner_id') is-invalid @enderror" required>
                                @foreach ($owners as $owner)
                                    <option value="{{ $owner->id }}" @selected((int) old('owner_id', $hotel->owner_id) === $owner->id)>
                        ...
                        <p class="small text-muted">
                            <a href="{{ route('manage.hotels.photos.index', $hotel) }}">Zarządzaj zdjęciami hotelu</a>
                        </p>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('manage.admin.hotels.show', $hotel) }}" class="btn btn-outline-secondary">Anuluj</a>
                        </div>
                    </form>
                </div>
            </div>
